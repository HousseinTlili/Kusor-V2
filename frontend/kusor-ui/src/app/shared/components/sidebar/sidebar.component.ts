...
@Component({
  ...
  template: `
    <aside class="fixed top-0 left-0 bottom-0 w-64 bg-[#03071E] border-r border-[#E85D04]/25 flex flex-col z-50 shadow-2xl">
      <!-- Brand Header -->
      <div class="p-6 border-b border-[#E85D04]/25 flex items-center gap-3 bg-[#03071E]">
        <img src="assets/attijari_logo.png" (error)="onLogoError($event)" alt="Attijari Bank Logo" class="h-9 w-auto object-contain hidden" id="attijari-logo-img" />
        <div id="attijari-logo-fallback" class="p-2.5 rounded-2xl bg-gradient-to-br from-[#E85D04] to-[#DC2F02] text-white shadow-lg shadow-[#E85D04]/30">
        ...
        <div>
          ...
          <div class="space-y-1">
            <a routerLink="/dashboard" routerLinkActive="bg-[#E85D04]/20 border-l-4 border-[#E85D04] text-[#E85D04] font-bold"
              class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs text-slate-300 hover:text-white hover:bg-slate-900/80 transition-all group">
      ...
      <!-- User Profile Drawer -->
      <div class="p-4 border-t border-[#E85D04]/25 flex items-center justify-between bg-[#03071E]">
        <div class="truncate">
        ...
        <button (click)="auth.logout()" class="p-2 rounded-xl bg-slate-900 hover:bg-rose-500/20 text-slate-400 hover:text-rose-400 border border-slate-800 transition-all">
...
export class SidebarComponent {
  ...
  onLogoError(event: any) {
    ...
    const fallback = document.getElementById('attijari-logo-fallback');
